...
(function(){
  ...
  function save(){
    if(document.body&&document.body.classList.contains('pcs-mode'))return;
  ...
  document.addEventListener('input',function(e){if(suppress||(document.body&&document.body.classList.contains('pcs-mode'))||!(e.target&&e.target.id))return;clearTimeout(timer);timer=setTimeout(save,500);},true);
