...
(function () {
  ...
  ready(async function () {
    try {
      ...
      var ALLOW = {
        full:null,
        manager:new Set(["home.html","todo.html","request.html","attendance.html","verify.html","dpr.html","dprlist.html","resource-summary.html","site-dashboard.html","pr-directory.html","pr-new.html","pr-dashboard.html","whatsapp.html","dashboard.html","reports.html","timesheet.html","worker-cards.html","settings.html","help.html"]),
        supervisor:new Set(["home.html","todo.html","request.html","attendance.html","dpr.html","dprlist.html","pr-new.html","whatsapp.html","dashboard.html","reports.html","worker-cards.html","settings.html","help.html"]),
      ...
      function navFor(rl){
        ...
        if (t === "supervisor") return [
          ...
          {grp:"More",items:[["Worker cards","worker-cards.html","doc"],["Settings","settings.html","gear"],["How to use","help.html","help"]]} ];
        var full = [
          {items:[["Home","home.html","home"],["To-do","todo.html","chk"]]},
          ...
          {grp:"More",items:[["WhatsApp","whatsapp.html","chat"],["Users","users.html","shield"],["Worker cards","worker-cards.html","doc"],["Settings","settings.html","gear"],["How to use","help.html","help"]]} ];
        var allow = ALLOW[t];
        ...
        if (rl === "operation_manager" || rl === "general_manager") {
          out = out.map(function(s){ return {grp:s.grp, items:s.items.filter(function(it){ return it[1] !== "worker-cards.html"; })}; }).filter(function(s){ return s.items.length; });
        }
        return out;
      }
      var NAVITEMS = [];
