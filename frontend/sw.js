...
const CACHE = 'vcms-v14-camera-stage2';
const APP_SHELL = [
  ...
  'css/app.css','js/config.js?v=20260813-8','js/auth.js?v=20260813-8','js/shell.js?v=20260813-8','js/camera-capture.js?v=20260814-1','icons/icon-192.png'
];
