...
const CACHE = 'vcms-v15-camera-stage3';
const APP_SHELL = [
  ...
  'css/app.css','js/config.js?v=20260813-8','js/auth.js?v=20260813-8','js/shell.js?v=20260813-8','js/camera-capture.js?v=20260814-2','icons/icon-192.png'
];
