...
const CACHE = 'vcms-v24-camera-text-direction';
const APP_SHELL = [
  ...
  'css/app.css','js/config.js?v=20260813-8','js/auth.js?v=20260813-8','js/shell.js?v=20260813-8','vendor/heic2any.min.js?v=0.0.4','js/camera-queue.js?v=20260814-1','js/camera-capture.js?v=20260814-9','icons/icon-192.png'
];
